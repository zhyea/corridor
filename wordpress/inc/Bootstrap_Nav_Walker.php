...
class Bootstrap_Nav_Walker extends Walker_Nav_Menu
{
     ...
     * @see Walker::start_el()
     */
    public function start_el(&$output, $item, $depth = 0, $current_page = 0, $args = array())
    {
        ...
        if (strcasecmp($item->attr_title, 'divider') == 0 && $depth === 1) {
            ...
            $attributes = array();
            $attributes['title'] = !empty($item->title) ? $item->title : '';
    ...
    public static function fallback($args)
    {
        if (current_user_can('manage_options')) {
            ...
            $fb_output .= '>';
            $fb_output .= '<li><a href="' . admin_url('ext-menus.php') . '">Add a menu</a></li>';
            $fb_output .= '</ul>';
