...
class Bootstrap_Nav_Walker extends Walker_Nav_Menu {
	...
	public static function fallback( $args ) {
		...
		$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'corridor' ) . '">' . esc_html__( 'Add a menu', 'corridor' ) . '</a></li>';
		$fallback_output .= '</ul>';
